...
public class Employee {
  ...
  public static void main(String[] args) throws IOException {
    ...
    employees[0] =
      new Employee("1001","R&D","Engineer","Vivek","1/04/2022",20000,8000,3000,'e');
    employees[1] =
      new Employee("1002","PM","Consultant","Ruhma","23/08/2022",30000,12000,9000,'c');
    employees[2] =
      new Employee("1003","Acct","Accountent","Abhi","12/11/2008",10000,8000,1000,'k');
    while(val) {
