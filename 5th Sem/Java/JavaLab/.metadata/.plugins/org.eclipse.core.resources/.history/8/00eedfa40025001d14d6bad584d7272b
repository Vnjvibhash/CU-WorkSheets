	    ...
	    switch (choice) {
	      case 1:
	        ...
	        try {
	          ...
	          System.out.println(
	            "Interest gained is : $ " + sb.calculateInterest(amount)
	          );
	        } catch (Exception e) {
	      ...
	      case 2:
	        try {
	          ...
	          System.out.println(
	            "Interest gained is: $ " + fd.calculateInterest(fAmount)
	          );
	        } catch (Exception e) {
	      ...
	      case 4:
	        System.out.println(
	          "DO YOU WANT TO CALCULATE AGAIN ????" + " " + "RUN AGAIN THE PROGRAM"
	        );
	        val=false;
	      default:
